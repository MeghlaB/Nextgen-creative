...
export default function PricingTable({ details = {} }) {
  ...
  const selectedService = details.services?.find(service => service.id === id);
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="inline-flex bg-white shadow-lg rounded-full p-1 mb-10">
          <button
            ...
            className={`px-6 py-2 rounded-full ${isFixed ? "bg-green-600 text-white" : "text-gray-700"}`}
          >
            Fixed
          </button>
          <button
        ...
        {selectedService ? (
          <div className={`grid ${filteredPlans.length === 1 ? "place-items-center" : "md:grid-cols-3"} gap-8`}>
              ...
              >
                <div>
                  ...
                  <p className="text-3xl font-bold mb-2">
                    {isFixed ? plan.monthly : plan.discountedPrice?.yearly || plan.yearly}
